    ...
    <div className="mx-auto max-w-[800px] space-y-6">
      ...
      <Card className="bg-[#101113] border-[#1a1b1e]">
        ...
        <CardContent className="space-y-3">
          <div className="rounded-md border border-[#1a1b1e] bg-[#0f1012] p-3">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-xs text-white/60">Co-founder, CTO • Joined 2 months ago</div>
              </div>
              <Button
                variant="outline"
                className="h-8 border-[#1a1b1e] text-white hover:bg-white/[0.06] bg-transparent"
              >
                Manage
              </Button>
            </div>
          ...
          <Button className="w-full bg-white text-[#0b0b0c] hover:bg-white/90">Invite team member</Button>
        </CardContent>
      </Card>
